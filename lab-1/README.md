...
#### *Традиционная* реализация (задача №3)
...
#### Рекурсивная реализация (задача №3)
...
#### Реализация с использованием map (задача №3)
...
#### Реализация с использованием ленивых вычислений (задача №3)
...
### Реализации (задача №28)

#### Реализация на C++ (задача №28)
...
#### *Традиционная* реализация (задача №28)
...
#### Рекурсивная реализация (задача №28)
...
#### Реализация с использованием map (задача №28)
...
#### Реализация с использованием ленивых вычислений (задача №28)
